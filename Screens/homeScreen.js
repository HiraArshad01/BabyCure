    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={{
                flex: 0.60, marginTop: 10, background: '#BADFE7', width: '80%', height: '100%', shadowColor: "#000",
                ...
                <Text style={{ fontSize: 16, fontWeight: '600'}}>Faizan</Text>
                <Text style={{ fontSize: 16, fontWeight: '600'}}>Mother</Text>
                </View>

                <Text style={{ fontSize: 16, fontWeight: '600', marginTop: 40 }}>Hi! Good Evening Azlan</Text>
                ...
                <Text style={{ fontSize: 16, fontWeight: '800', marginTop: 40 }}>2 Months                                                                       1 Week</Text>
            </TouchableOpacity>

            <TouchableOpacity style={{
                flex: 0.10, marginTop: 10, background: '#BADFE7', width: '80%', height: '100%', shadowColor: "#000",
                shadowOffset: { width: 0, height: 4, }, shadowOpacity: 0.30, shadowRadius: 4.65,
                ...
                <Text style={{ fontSize: 18, fontWeight: '700', marginTop: 10 }}>BMI Calculator</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={{
                ...
                <Text style={{ fontSize: 18, fontWeight: '700', marginTop: 10 }}>Common Problems</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity style={{
                ...
                <Text style={{ fontSize: 18, fontWeight: '700', marginTop: 10 }}>DIY Remedies & Recipes</Text>
