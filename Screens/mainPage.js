             ...
             <ImageBackground source={image} resizeMode="cover" style={styles.image}>
                <View style={{flex:1, backgroundColor:"#000000c0", justifyContent:'center'}}>
                        ...
                        <View style={{flex:0.20, justifyContent:'center', flexDirection:'row' }}>
                           ...
                           <TouchableOpacity onPress={()=>navigation.navigate('RegisterScreen')}>  <Text style={{ color: "red",fontSize: 28,fontWeight: "bold",textAlign: "center",
                           marginLeft: 20, marginRight: 20}}>Signup</Text></TouchableOpacity>
                            
                        </View>
                        <View style={{flex:0.20, justifyContent:'center', flexDirection:'row'}}>
                            <Text style={styles.text}>Already a Member?</Text>
                           <TouchableOpacity onPress={()=>navigation.navigate('mainPageChoose')} >    <Text style={{ color: "red",fontSize: 28,fontWeight: "bold",textAlign: "center",
                           marginLeft: 20, marginRight: 20}}>Login</Text></TouchableOpacity>
